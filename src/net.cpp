...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Frozenmist " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"frozenmistcoin.com", "188.166.151.162"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"frozenmistcoin.com", "127.0.0.1"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Frozenmist is probably already running."), addrBind.ToString().c_str());
        else
